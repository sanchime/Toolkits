...
public class SnowflakeOptions
{
    ...
    /// （1-漂移算法|2-传统算法），默认1
    /// </summary>
    public virtual SnowflakeMode Method { get; set; } = SnowflakeMode.Drift;

    /// <summary>
    /// 基础时间（UTC格式）
    /// 不能超过当前系统时间
    /// </summary>
    public virtual DateTime BaseTime { get; set; } = new DateTime(1970, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc);
    ...
    public SnowflakeOptions(ushort workerId)
    {
        WorkerId = workerId;
    }
